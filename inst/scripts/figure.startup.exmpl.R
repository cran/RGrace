hooks.user.menu <- function(fig){
  all.hooks <- list(element=c("default.hook","simple.calculus","delete.in.range","lf.in.range","sort.data","move.indexed","move.indexed.y","smooth.data","spline.data"),
                    region=c("default.hook","simple.calculus","delete.in.range","lf.in.range","sort.data","smooth.data","spline.data"),
